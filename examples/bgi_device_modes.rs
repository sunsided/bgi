...
fn main() {
    ...
    println!("DETECT = {}, CGA = {}, MCGA = {}, EGA = {}", DETECT, CGA, MCGA, EGA);
    println!("EGA64 = {}, EGAMONO = {}, IBM8514 = {}, HERCMONO = {}", EGA64, EGAMONO, IBM8514, HERCMONO);
    println!("ATT400 = {}, VGA = {}, PC3270 = {}", ATT400, VGA, PC3270);
    
    println!("\nAvailable Mode Constants:");
    println!("CGA: CGAHI = {}, CGAMED = {}, CGALO = {}", CGAHI, CGAMED, CGALO);
    println!("EGA: EGAHI = {}, EGA64LO = {}, EGAMED = {}", EGAHI, EGA64LO, EGAMED);
    println!("VGA: VGALO = {}, VGAHI = {}, VGAMED = {}", VGALO, VGAHI, VGAMED);
